...
- [Solution Architect Role](../solution-architect/SKILL.md) -- Collaborator on fit-gap analysis and technical feasibility
- [Compliance Analyst Role](../compliance-analyst/SKILL.md) -- Collaborator on regulatory requirements
- [Fit-Gap Matrix Template](../../templates/fit-gap-matrix/SKILL.md) -- Scoring template for requirement evaluation
- [Requirements Traceability Template](../../templates/requirements-traceability/SKILL.md) -- RTM template for tracking coverage
- [Workflow Automation Skill](../../skills/technical/workflow-automation/SKILL.md) -- Implementation patterns for process requirements
- [Data Modeling Skill](../../skills/technical/data-modeling/SKILL.md) -- Entity design for data requirements
- [Finance & Accounting Domain](../../domains/finance-accounting/SKILL.md) -- Domain-specific requirements for financial modules
- [Supply Chain Domain](../../domains/supply-chain/SKILL.md) -- Domain-specific requirements for procurement and inventory
