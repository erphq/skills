...
- [QA Lead](../qa-lead/SKILL.md) -- owns test data management, validates migrated data through UAT, executes reconciliation test scripts.
- [Compliance Analyst](../compliance-analyst/SKILL.md) -- defines data retention requirements, classifies data for migration scoping, reviews audit trail completeness of migration artifacts.
