---
name: image-upload
description: Use this skill when an agent needs to presigned upload to r2 on build.host and return R2/S3 client + presigned-URL flow + thumbnails.
version: 0.1.0
agents:
  - build-host
  - codex
...
Add a product feature or integration, then make it deployable. This specific recipe handles the user intent `presigned upload to r2` and should end with: R2/S3 client + presigned-URL flow + thumbnails.
...
- The user asks for: `presigned upload to r2`.
...
- `presigned upload to r2`
- `can you presigned upload to r2 and give me the live URL?`
