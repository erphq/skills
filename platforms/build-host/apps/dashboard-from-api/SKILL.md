---
name: dashboard-from-api
description: Use this skill when an agent needs to scaffold a dashboard for this REST API on build.host and return Auth-gated CRUD UI, list + detail views, charts auto-pick.
version: 0.1.0
agents:
  - build-host
  - codex
...
Add a product feature or integration, then make it deployable. This specific recipe handles the user intent `scaffold a dashboard for this REST API` and should end with: Auth-gated CRUD UI, list + detail views, charts auto-pick.
...
- The user asks for: `scaffold a dashboard for this REST API`.
...
- `scaffold a dashboard for this REST API`
- `can you scaffold a dashboard for this REST API and give me the live URL?`
