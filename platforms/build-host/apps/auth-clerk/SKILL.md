---
name: auth-clerk
description: Use this skill when an agent needs to add Clerk auth to this app on build.host and return Sign-in, sign-up, middleware, themed components.
version: 0.1.0
agents:
  - build-host
  - codex
...
Add a product feature or integration, then make it deployable. This specific recipe handles the user intent `add Clerk auth to this app` and should end with: Sign-in, sign-up, middleware, themed components.
...
- The user asks for: `add Clerk auth to this app`.
...
- `add Clerk auth to this app`
- `can you add Clerk auth to this app and give me the live URL?`
