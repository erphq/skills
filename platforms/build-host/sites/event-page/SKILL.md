---
name: event-page
description: Use this skill when an agent needs to page for an event on march 12 on build.host and return Single-page event w/ schedule, speakers, RSVP, map.
version: 0.1.0
agents:
  - build-host
  - codex
...
Generate a focused site, then ship it to build.host. This specific recipe handles the user intent `page for an event on march 12` and should end with: Single-page event w/ schedule, speakers, RSVP, map.
...
- The user asks for: `page for an event on march 12`.
...
- `page for an event on march 12`
- `can you page for an event on march 12 and give me the live URL?`
