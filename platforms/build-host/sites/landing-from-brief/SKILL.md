---
name: landing-from-brief
description: Use this skill when an agent needs to build a landing page for "agent-deployed terminal sharing" on build.host and return Hero, three-feature row, install snippet, footer. Brand-tunable.
version: 0.1.0
agents:
  - build-host
  - codex
...
Generate a focused site, then ship it to build.host. This specific recipe handles the user intent `build a landing page for "agent-deployed terminal sharing"` and should end with: Hero, three-feature row, install snippet, footer. Brand-tunable.
...
- The user asks for: `build a landing page for "agent-deployed terminal sharing"`.
...
- `build a landing page for "agent-deployed terminal sharing"`
- `can you build a landing page for "agent-deployed terminal sharing" and give me the live URL?`
