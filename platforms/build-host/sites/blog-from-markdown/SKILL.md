---
name: blog-from-markdown
description: Use this skill when an agent needs to make a blog from this markdown folder on build.host and return Post index, RSS, slug routing, code highlighting.
version: 0.1.0
agents:
  - build-host
  - codex
...
Generate a focused site, then ship it to build.host. This specific recipe handles the user intent `make a blog from this markdown folder` and should end with: Post index, RSS, slug routing, code highlighting.
...
- The user asks for: `make a blog from this markdown folder`.
...
- `make a blog from this markdown folder`
- `can you make a blog from this markdown folder and give me the live URL?`
