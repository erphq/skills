---
name: docs-site
description: Use this skill when an agent needs to make a docs site for this api on build.host and return Sidebar, search, code samples, version switcher.
version: 0.1.0
agents:
  - build-host
  - codex
...
Generate a focused site, then ship it to build.host. This specific recipe handles the user intent `make a docs site for this api` and should end with: Sidebar, search, code samples, version switcher.
...
- The user asks for: `make a docs site for this api`.
...
- `make a docs site for this api`
- `can you make a docs site for this api and give me the live URL?`
