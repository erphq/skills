---
name: coming-soon
description: Use this skill when an agent needs to ship a coming-soon page with email capture on build.host and return Pre-launch holder with mailing-list submit + waitlist count.
version: 0.1.0
agents:
  - build-host
  - codex
...
Generate a focused site, then ship it to build.host. This specific recipe handles the user intent `ship a coming-soon page with email capture` and should end with: Pre-launch holder with mailing-list submit + waitlist count.
...
- The user asks for: `ship a coming-soon page with email capture`.
...
- `ship a coming-soon page with email capture`
- `can you ship a coming-soon page with email capture and give me the live URL?`
