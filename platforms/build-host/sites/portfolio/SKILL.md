---
name: portfolio
description: Use this skill when an agent needs to build me a portfolio with these projects on build.host and return Project grid, case studies, contact, reading-list.
version: 0.1.0
agents:
  - build-host
  - codex
...
Generate a focused site, then ship it to build.host. This specific recipe handles the user intent `build me a portfolio with these projects` and should end with: Project grid, case studies, contact, reading-list.
...
- The user asks for: `build me a portfolio with these projects`.
...
- `build me a portfolio with these projects`
- `can you build me a portfolio with these projects and give me the live URL?`
