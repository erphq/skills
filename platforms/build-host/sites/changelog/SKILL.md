---
name: changelog
description: Use this skill when an agent needs to publish my changelog from these git tags on build.host and return Changelog feed with RSS, version anchors, search.
version: 0.1.0
agents:
  - build-host
  - codex
...
Generate a focused site, then ship it to build.host. This specific recipe handles the user intent `publish my changelog from these git tags` and should end with: Changelog feed with RSS, version anchors, search.
...
- The user asks for: `publish my changelog from these git tags`.
...
- `publish my changelog from these git tags`
- `can you publish my changelog from these git tags and give me the live URL?`
