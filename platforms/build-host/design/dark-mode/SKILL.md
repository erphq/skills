---
name: dark-mode
description: Use this skill when an agent needs to add dark/light toggle on build.host and return Toggle, persistent choice, prefers-color-scheme respect.
version: 0.1.0
agents:
  - build-host
  - codex
...
- `can you add dark/light toggle and give me the live URL?`
