...
Apply a visual system to an existing app or new surface. This specific recipe handles the user intent `give me a magazine-style theme` and should end with: Serif display + sans body, drop caps, asymmetric grid.
...
- The user asks for: `give me a magazine-style theme`.
...
- `give me a magazine-style theme`
- `can you give me a magazine-style theme and give me the live URL?`
