...
description: Use this skill when an agent needs to apply brutalist theme to this app on build.host and return Sharp corners, 1px borders, mono labels, hard offset shadows.
version: 0.1.0
agents:
  - build-host
  - codex
...
Apply a visual system to an existing app or new surface. This specific recipe handles the user intent `apply brutalist theme to this app` and should end with: Sharp corners, 1px borders, mono labels, hard offset shadows.
...
- The user asks for: `apply brutalist theme to this app`.
...
- `apply brutalist theme to this app`
- `can you apply brutalist theme to this app and give me the live URL?`
