---
name: split-hero
description: Use this skill when an agent needs to dual-audience split hero on build.host and return 50/50 hero with humans-left / agents-right rhetoric.
version: 0.1.0
agents:
  - build-host
  - codex
...
Apply a visual system to an existing app or new surface. This specific recipe handles the user intent `dual-audience split hero` and should end with: 50/50 hero with humans-left / agents-right rhetoric.
...
- The user asks for: `dual-audience split hero`.
...
- `dual-audience split hero`
- `can you dual-audience split hero and give me the live URL?`
