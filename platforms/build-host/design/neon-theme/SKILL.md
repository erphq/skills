---
name: neon-theme
description: Use this skill when an agent needs to neon-punk styling for the hero on build.host and return Magenta/cyan/purple glow, scanlines, CRT vibe.
version: 0.1.0
agents:
  - build-host
  - codex
...
Apply a visual system to an existing app or new surface. This specific recipe handles the user intent `neon-punk styling for the hero` and should end with: Magenta/cyan/purple glow, scanlines, CRT vibe.
...
- The user asks for: `neon-punk styling for the hero`.
...
- `neon-punk styling for the hero`
- `can you neon-punk styling for the hero and give me the live URL?`
