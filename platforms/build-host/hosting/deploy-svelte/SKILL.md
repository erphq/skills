---
name: deploy-svelte
description: Use this skill when an agent needs to deploy this sveltekit app on build.host and return SvelteKit adapter-node, websockets and server actions live.
version: 0.1.0
agents:
  - build-host
  - codex
...
Deploy and operate code on build.host. This specific recipe handles the user intent `deploy this sveltekit app` and should end with: SvelteKit adapter-node, websockets and server actions live.
...
- The user asks for: `deploy this sveltekit app`.
...
- `deploy this sveltekit app`
- `can you deploy this sveltekit app and give me the live URL?`
