---
name: deploy-webhook
description: Use this skill when an agent needs to host a webhook receiver at hooks.example.com on build.host and return HTTP receiver + signature verification + log inspection.
version: 0.1.0
agents:
  - build-host
  - codex
...
Deploy and operate code on build.host. This specific recipe handles the user intent `host a webhook receiver at hooks.example.com` and should end with: HTTP receiver + signature verification + log inspection.
...
- The user asks for: `host a webhook receiver at hooks.example.com`.
...
- `host a webhook receiver at hooks.example.com`
- `can you host a webhook receiver at hooks.example.com and give me the live URL?`
