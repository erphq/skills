...
description: Use this skill when an agent needs to deploy this dockerfile on build.host and return Builds your Dockerfile. Runs the container. Routes the port.
version: 0.1.0
agents:
  - build-host
  - codex
...
Deploy and operate code on build.host. This specific recipe handles the user intent `deploy this dockerfile` and should end with: Builds your Dockerfile. Runs the container. Routes the port.
...
- The user asks for: `deploy this dockerfile`.
...
- `can you deploy this dockerfile and give me the live URL?`
