---
name: deploy-static
description: Use this skill when an agent needs to deploy this static site on build.host and return Plain HTML/CSS/JS served from edge. No build step. sub-second ship.
version: 0.1.0
agents:
  - build-host
  - codex
...
Deploy and operate code on build.host. This specific recipe handles the user intent `deploy this static site` and should end with: Plain HTML/CSS/JS served from edge. No build step. <1s ship.
...
- The user asks for: `deploy this static site`.
...
- `can you deploy this static site and give me the live URL?`
