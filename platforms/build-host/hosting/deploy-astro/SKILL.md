---
name: deploy-astro
description: Use this skill when an agent needs to deploy this astro site on build.host and return Astro SSG/SSR, content collections, partial hydration.
version: 0.1.0
agents:
  - build-host
  - codex
...
Deploy and operate code on build.host. This specific recipe handles the user intent `deploy this astro site` and should end with: Astro SSG/SSR, content collections, partial hydration.
...
- The user asks for: `deploy this astro site`.
...
- `deploy this astro site`
- `can you deploy this astro site and give me the live URL?`
