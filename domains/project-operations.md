...
- [Finance & Accounting](finance-accounting.md) -- project revenue recognition, WIP accounting, AR for project invoices
- [Human Resources](human-resources.md) -- employee data, availability, payroll integration for billable hours
- [Sales & CRM](sales-crm.md) -- opportunity-to-project conversion, client account management, services pipeline
