...
- [Finance & Accounting](../finance-accounting/SKILL.md) -- project revenue recognition, WIP accounting, AR for project invoices
- [Human Resources](../human-resources/SKILL.md) -- employee data, availability, payroll integration for billable hours
- [Sales & CRM](../sales-crm/SKILL.md) -- opportunity-to-project conversion, client account management, services pipeline
