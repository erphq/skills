...
- [Sales & CRM](sales-crm.md) -- customer 360 view, churn risk signals from support, account context for agents
- [Finance & Accounting](finance-accounting.md) -- SLA penalty credits, billing adjustments from support issues
- [Human Resources](human-resources.md) -- agent staffing, scheduling, training, performance management
