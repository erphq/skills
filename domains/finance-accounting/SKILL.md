...
- [Supply Chain](../supply-chain/SKILL.md) -- procurement and inventory transactions feed AP and GL
- [Human Resources](../human-resources/SKILL.md) -- payroll journals post to GL; benefits accruals
- [Sales & CRM](../sales-crm/SKILL.md) -- order-to-cash cycle, revenue recognition, commissions
- [Project Operations](../project-operations/SKILL.md) -- project accounting, WIP, revenue recognition for services
- [Customer Support](../customer-support/SKILL.md) -- credit memos and billing adjustments from support cases
