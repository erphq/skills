...
- [Supply Chain](supply-chain.md) -- procurement and inventory transactions feed AP and GL
- [Human Resources](human-resources.md) -- payroll journals post to GL; benefits accruals
- [Sales & CRM](sales-crm.md) -- order-to-cash cycle, revenue recognition, commissions
- [Project Operations](project-operations.md) -- project accounting, WIP, revenue recognition for services
- [Customer Support](customer-support.md) -- credit memos and billing adjustments from support cases
