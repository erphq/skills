...
- [Finance & Accounting](../finance-accounting/SKILL.md) -- payroll journals, benefits accruals, headcount-driven budgeting
- [Project Operations](../project-operations/SKILL.md) -- resource management, utilization, billable time tracking
- [Customer Support](../customer-support/SKILL.md) -- agent staffing, scheduling, workforce management
