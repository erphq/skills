...
- [Finance & Accounting](../finance-accounting/SKILL.md) -- inventory valuation, AP from procurement, COGS posting
- [Sales & CRM](../sales-crm/SKILL.md) -- sales orders drive fulfillment, ATP queries, demand forecast
- [Project Operations](../project-operations/SKILL.md) -- project-based procurement, material costs on projects
