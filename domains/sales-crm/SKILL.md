...
- [Finance & Accounting](../finance-accounting/SKILL.md) -- order-to-cash, revenue recognition, AR, commission accruals
- [Supply Chain](../supply-chain/SKILL.md) -- order fulfillment, ATP, delivery scheduling
- [Customer Support](../customer-support/SKILL.md) -- case history in customer 360, escalation impacts on renewals
- [Project Operations](../project-operations/SKILL.md) -- services opportunities, SOW-based selling, project-based revenue
