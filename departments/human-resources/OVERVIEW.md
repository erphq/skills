...
- [Finance & Accounting](../finance-accounting/OVERVIEW.md) -- payroll journals, benefits accruals, headcount-driven budgeting
- [Project Operations](../project-operations/OVERVIEW.md) -- resource management, utilization, billable time tracking
- [Customer Support](../customer-support/OVERVIEW.md) -- agent staffing, scheduling, workforce management
