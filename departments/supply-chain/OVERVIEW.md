...
- [Finance & Accounting](../finance-accounting/OVERVIEW.md) -- inventory valuation, AP from procurement, COGS posting
- [Sales & CRM](../sales-crm/OVERVIEW.md) -- sales orders drive fulfillment, ATP queries, demand forecast
- [Project Operations](../project-operations/OVERVIEW.md) -- project-based procurement, material costs on projects
