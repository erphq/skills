...
- [Finance & Accounting](../finance-accounting/OVERVIEW.md) -- order-to-cash, revenue recognition, AR, commission accruals
- [Supply Chain](../supply-chain/OVERVIEW.md) -- order fulfillment, ATP, delivery scheduling
- [Customer Support](../customer-support/OVERVIEW.md) -- case history in customer 360, escalation impacts on renewals
- [Project Operations](../project-operations/OVERVIEW.md) -- services opportunities, SOW-based selling, project-based revenue
