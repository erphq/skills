...
description: This skill should be used when the task involves how to match the right people to the right projects based on skills, availability, and utilization targets.
version: 1.0.0
metadata:
  author: erphq
  domain: erpai.studio
