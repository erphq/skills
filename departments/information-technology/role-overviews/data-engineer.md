...
- [Data Modeling Skill](../03-org-1k-plus/data-modeling/SKILL.md) -- Detailed implementation guidance for entity design in ERP•AI
- [Data Migration Skill](../03-org-1k-plus/data-migration/SKILL.md) -- End-to-end migration execution patterns
...
- [Reports & Dashboards Skill](../03-org-1k-plus/reports-dashboards/SKILL.md) -- Analytical schema design for BI
- [Performance Optimization Skill](../03-org-1k-plus/performance-optimization/SKILL.md) -- Query tuning and indexing strategies
- [Migration Runbook Template](../../../templates/03-org-1k-plus/migration-runbook/SKILL.md) -- Step-by-step cutover checklist
