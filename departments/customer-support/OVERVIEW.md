...
- [Sales & CRM](../sales-crm/OVERVIEW.md) -- customer 360 view, churn risk signals from support, account context for agents
- [Finance & Accounting](../finance-accounting/OVERVIEW.md) -- SLA penalty credits, billing adjustments from support issues
- [Human Resources](../human-resources/OVERVIEW.md) -- agent staffing, scheduling, training, performance management
