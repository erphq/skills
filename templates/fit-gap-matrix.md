...
- [Requirements Analyst](../roles/requirements-analyst.md) — The role that drives this process
- [Solution Architect](../roles/solution-architect.md) — Validates technical fit ratings and effort estimates
- [Requirements Traceability](requirements-traceability.md) — Links these requirements forward to config and test
- [Go-Live Checklist](go-live-checklist.md) — Must Have items feed directly into go/no-go criteria
