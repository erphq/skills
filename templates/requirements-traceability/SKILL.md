...
- [Requirements Analyst](../../roles/requirements-analyst/SKILL.md) — Owns the requirements side of traceability
- [QA Lead](../../roles/qa-lead/SKILL.md) — Owns the testing side of traceability
- [Testing & Validation](../../skills/technical/testing-validation/SKILL.md) — How to write the test cases
