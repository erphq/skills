...
- [Deployment & Go-Live](../../skills/technical/deployment-golive/SKILL.md) — The skill guide for the full go-live process
...
- [QA Lead](../../roles/qa-lead/SKILL.md) — Owns testing readiness
- [Compliance Analyst](../../roles/compliance-analyst/SKILL.md) — Validates regulatory readiness
