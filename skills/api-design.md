...
- [Integrations](integrations.md) -- integration design patterns that consume and produce API calls
- [Security & Roles](security-roles.md) -- RBAC and OAuth scope design that governs API authorization
- [Data Modeling](data-modeling.md) -- entity models that underpin API resource design
- [Configuration Management](configuration-management.md) -- API-first configuration management and API versioning lifecycle
