...
- [Disaster Recovery](disaster-recovery.md) -- incident response extends into DR when incidents become outages
- [Security & Roles](security-roles.md) -- audit logging and security event monitoring
- [Integrations](integrations.md) -- integration observability is critical for ERP reliability
- [Workflow Automation](workflow-automation.md) -- monitoring workflow execution and performance
