...
- [Data Modeling](data-modeling.md) -- designing the schemas that master data entities follow
- [Data Migration](data-migration.md) -- migrating master data from legacy systems into the MDM hub
- [Integrations](integrations.md) -- building the sync pipelines between MDM hub and connected systems
- [Security & Roles](security-roles.md) -- controlling who can create, modify, merge, and approve master data
