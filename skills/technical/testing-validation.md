...
- [Deployment & Go-Live](skills/deployment-golive.md) -- testing is a prerequisite for go-live approval
- [Data Modeling](skills/data-modeling.md) -- validation rules originate from the data model
- [Workflow Automation](skills/workflow-automation.md) -- workflow logic must be tested across state transitions
- [Security & Roles](skills/security-roles.md) -- security testing validates role-based access controls
- [QA Lead](roles/qa-lead.md) -- the role persona responsible for test strategy and execution
- [Requirements Traceability](templates/requirements-traceability.md) -- template for linking requirements to test cases
