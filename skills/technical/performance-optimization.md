...
- [Data Modeling](skills/data-modeling.md) -- schema design (normalization, indexing) is the foundation of query performance
- [Reports & Dashboards](skills/reports-dashboards.md) -- report queries are often the heaviest database consumers
- [Deployment & Go-Live](skills/deployment-golive.md) -- performance testing is a go-live gate
- [Solution Architect](roles/solution-architect.md) -- the role that owns infrastructure and scaling decisions
