...
- [Data Modeling](data-modeling.md) -- the entities and fields that workflows operate on
- [Security & Roles](security-roles.md) -- who can trigger, approve, and override workflow steps
- [Integrations](integrations.md) -- connecting workflows to external systems via webhooks and API triggers
