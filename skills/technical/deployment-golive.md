...
- [Testing & Validation](skills/testing-validation.md) -- testing is a prerequisite gate for the go/no-go decision
- [Data Migration](skills/data-migration.md) -- data migration tasks are a major component of the cutover runbook
- [Security & Roles](skills/security-roles.md) -- access provisioning is part of cutover
- [User Onboarding](skills/user-onboarding.md) -- training must be complete before go-live
- [Go-Live Checklist](templates/go-live-checklist.md) -- template for the go/no-go criteria checklist
- [Migration Runbook](templates/migration-runbook.md) -- template for the data migration portion of the cutover
- [Solution Architect](roles/solution-architect.md) -- the role that owns environment strategy and deployment architecture
