...
- [Deployment & Go-Live](skills/deployment-golive.md) -- training must complete before go-live; hypercare bridges the gap
- [Security & Roles](skills/security-roles.md) -- training paths align with security roles; users train on what they have access to
- [Workflow Automation](skills/workflow-automation.md) -- workflow changes drive retraining needs
- [Reports & Dashboards](skills/reports-dashboards.md) -- dashboard training is part of manager onboarding
- [Human Resources](domains/human-resources.md) -- LMS integration and organizational hierarchy for training assignments
