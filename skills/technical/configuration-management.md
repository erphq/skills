...
- [Security & Roles](security-roles.md) -- RBAC policies that govern who can modify configuration and access secrets
- [Integrations](integrations.md) -- integration configuration (endpoints, credentials, mappings) managed through this pipeline
- [Workflow Automation](workflow-automation.md) -- approval workflows that gate configuration promotions
- [Data Migration](data-migration.md) -- data migration configuration packages promoted alongside schema and data changes
