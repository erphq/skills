...
- [Data Migration](data-migration.md) -- data migration is a major change driver and communication topic
- [Workflow Automation](workflow-automation.md) -- new workflows require process change management
- [Master Data Management](master-data-management.md) -- MDM stewardship programs require change management
- [Security & Roles](security-roles.md) -- role changes are a key impact area in ERP implementations
